...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-4380e88a');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-4380e88a');}
...
var brandEl=document.querySelector('.rl-brand-4380e88a');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
